...
export const SignUp = () => {
    ...
    const handleLogin = () => {
        if(password===repassword && input!="" ){
          Axios.get("https://project-1-client-backend.vercel.app/users").then((response)=>{
          ...
          Axios.post("https://project-1-client-backend.vercel.app/signup",{username:input,password:password}).then((e)=>{
                console.log(e);
            })
            navigate("/")
        }else{
